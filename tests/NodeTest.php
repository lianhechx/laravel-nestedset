...
class NodeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testToTreeWithSpecifiedRoot()
    {
        ...
        $tree1 = \Opbol\Nestedset\Collection::make($nodes)->toTree(5);
        $tree2 = \Opbol\Nestedset\Collection::make($nodes)->toTree($node);
